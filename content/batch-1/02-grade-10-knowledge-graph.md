...
| 定义 | M1-C04-S05-K02 | 4.5 零点存在判断：用连续变化中的异号信息定位 | 核心高频 | 为二分法和数值近似提供可检验区间。 | M1-C04-S05-K01，M1-C03-S02-K02 |
| 定义 | M1-C04-S05-K03 | 4.5 二分法：迭代缩小零点区间并控制精度 | 综合应用 | 组合区间、函数值符号与近似思想，形成算法意识。 | M1-C04-S05-K02，M1-C01-S03-K01 |
...
| 定义 | M1-C05-S05-K05 | 5.5 二倍角公式与简单恒等变换 | 核心高频 | 组合降次、化简与求值，是解三角形和图象变换工具。 | M1-C05-S05-K02，M1-C05-S05-K03 |
...
**册内编号：** `M2-C01`　**章节树：** 6.1 平面向量的概念 → 6.2 平面向量的运算（含数量积）→ 6.3 平面向量基本定理及坐标表示 → 6.4 平面向量的应用（向量方法、正弦定理、余弦定理与解三角形）。
...
**册内编号：** `M2-C03`　**章节树：** 8.1 基本立体图形 → 8.2 直观图 → 8.3 表面积与体积；8.4 空间点、直线、平面的位置关系 → 8.5 平行 → 8.6 垂直。
...
| 定义 | M2-C03-S03-K03 | 8.3 球的表面积、体积与组合体度量 | 综合应用 | 组合球、柱锥体和切接关系完成空间计算。 | M2-C03-S01-K02，M2-C03-S03-K01，M2-C03-S03-K02 |
...
| 定义 | M2-C03-S06-K07 | 8.6 空间平行与垂直的综合证明 | 综合应用 | 组合线线、线面、面面的判定与性质，要求说明每次转化依据。 | M2-C03-S05-K05，M2-C03-S06-K06 |
...
| 定义 | M2-C04-S01-K04 | 9.1 数据获取途径、抽样误差与偏差辨析 | 综合应用 | 组合调查设计和情境判断，明确统计结论的可信边界。 | M2-C04-S01-K02，M2-C04-S01-K03 |
...
| 定义 | M2-C04-S02-K04 | 9.2 众数、中位数、平均数与集中趋势 | 核心高频 | 根据分布和异常值选择有解释力的代表量。 | M2-C04-S02-K01 |
| 定义 | M2-C04-S02-K05 | 9.2 极差、方差、标准差与离散程度 | 核心高频 | 衡量波动并与集中趋势共同描述数据。 | M2-C04-S02-K04 |
| 定义 | M2-C04-S02-K06 | 9.2 用样本数字特征估计总体 | 综合应用 | 组合抽样代表性、中心和离散程度作有边界的推断。 | M2-C04-S01-K04，M2-C04-S02-K03，M2-C04-S02-K05 |
| 定义 | M2-C04-S03-K01 | 9.3 统计案例：提出问题、整理数据、分析并表达结论 | 综合应用 | 串联抽样、图表、数字特征和情境解释形成完整调查链。 | M2-C04-S02-K02，M2-C04-S02-K06 |
| 定义 | M2-C04-S03-K02 | 9.3 统计结论的局限：区分数据证据、推断与因果 | 综合应用 | 防止把相关现象、样本结论或偏差数据夸大为因果事实。 | M2-C04-S01-K04，M2-C04-S03-K01 |
...
| 定义 | M2-C05-S01-K08 | 10.1 对立事件的概率计算 | 核心高频 | 用样本空间中的补集简化“不发生”或“至少一个”等问题。 | M2-C05-S01-K06，M1-C01-S03-K02 |
...
| 定义 | M2-C05-S03-K02 | 10.3 用随机模拟估计概率并评价误差 | 综合应用 | 组合抽样、频率和模型检验，理解估计而非精确替代。 | M2-C05-S03-K01，M2-C04-S01-K04 |
